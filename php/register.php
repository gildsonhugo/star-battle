...
$conn = new PDO('mysql:host=localhost;dbname=br_client_side_1;charset=utf8', 'root', '', [PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_OBJ, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
...
$stmtSelect = $conn->query('SELECT * FROM ranking ORDER BY score desc');
